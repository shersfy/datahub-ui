...
!function(a,t){a.fn.bootpag=function(t){function s(t,s){s=parseInt(s,10);var r,n=0==e.maxVisible?1:e.maxVisible,o=1==e.maxVisible?0:1,f=Math.floor((s-1)/n)*n,p=t.find("li");if(e.page=s=0>s?0:s>e.total?e.total:s,p.removeClass(e.activeClass),r=1>s-1?1:e.leaps&&s-1>=e.maxVisible?Math.floor((s-1)/n)*n:s-1,e.firstLastUse&&p.first().toggleClass(e.disabledClass,1===s),n=p.first(),e.firstLastUse&&(n=n.next()),n.toggleClass(e.disabledClass,1===s).attr("data-lp",r).find("a").attr("href",l(r)),o=1==e.maxVisible?0:1,r=s+1>e.total?e.total:e.leaps&&s+1<e.total-e.maxVisible?f+e.maxVisible+o:s+1,n=p.last(),e.firstLastUse&&(n=n.prev()),n.toggleClass(e.disabledClass,s===e.total).attr("data-lp",r).find("a").attr("href",l(r)),p.last().toggleClass(e.disabledClass,s===e.total),n=p.filter("[data-lp="+s+"]"),o="."+[e.nextClass,e.prevClass,e.firstClass,e.lastClass].join(",."),!n.not(o).length){var d=s<=f?-e.maxVisible:0;p.not(o).each(function(t){r=t+1+f+d,a(this).attr("data-lp",r).toggle(r<=e.total).find("a").html(r).attr("href",l(r))}),n=p.filter("[data-lp="+s+"]")}n.not(o).addClass(e.activeClass),i.data("settings",e)}function l(a){return e.href.replace(e.hrefVariable,a)}var i=this,e=a.extend({total:0,page:1,maxVisible:null,leaps:!0,href:"javascript:void(0);",hrefVariable:"{{number}}",next:"&raquo;",prev:"&laquo;",firstLastUse:!1,first:'<span aria-hidden="true">&larr;</span>',last:'<span aria-hidden="true">&rarr;</span>',wrapClass:"pagination",activeClass:"active",disabledClass:"disabled",nextClass:"next",prevClass:"prev",lastClass:"last",firstClass:"first"},i.data("settings")||{},t||{});return 0>=e.total?this:(a.isNumeric(e.maxVisible)||e.maxVisible||(e.maxVisible=parseInt(e.total,10)),i.data("settings",e),this.each(function(){var t,r,n=a(this);for(t=['<ul class="',e.wrapClass,' bootpag">'],e.firstLastUse&&(t=t.concat(['<li data-lp="1" class="',e.firstClass,'"><a href="',l(1),'">',e.first,"</a></li>"])),e.prev&&(t=t.concat(['<li data-lp="1" class="',e.prevClass,'"><a href="',l(1),'">',e.prev,"</a></li>"])),r=1;r<=Math.min(e.total,e.maxVisible);r++)t=t.concat(['<li data-lp="',r,'"><a href="',l(r),'">',r,"</a></li>"]);e.next&&(r=e.leaps&&e.total>e.maxVisible?Math.min(e.maxVisible+1,e.total):2,t=t.concat(['<li data-lp="',r,'" class="',e.nextClass,'"><a href="',l(r),'">',e.next,"</a></li>"])),e.firstLastUse&&(t=t.concat(['<li data-lp="',e.total,'" class="last"><a href="',l(e.total),'">',e.last,"</a></li>"])),t.push("</ul>"),n.find("ul.bootpag").remove(),n.append(t.join("")),t=n.find("ul.bootpag"),n.find("li").click(function(){var t=a(this);if(!t.hasClass(e.disabledClass)&&!t.hasClass(e.activeClass)){var l=parseInt(t.attr("data-lp"),10);i.find("ul.bootpag").each(function(){s(a(this),l)}),i.trigger("page",l)}}),s(t,e.page)}))}}(jQuery,window);
!function(){function e(e){return e.replace(h,"").replace(v,",").replace(m,"").replace(y,"").replace(b,"").split(w)}function n(e){return"'"+e.replace(/('|\\)/g,"\\$1").replace(/\r/g,"\\r").replace(/\n/g,"\\n")+"'"}function r(r,t){function a(e){return d+=e.split(/\n/).length-1,u&&(e=e.replace(/\s+/g," ").replace(/<!--[\w\W]*?-->/g,"")),e&&(e=m[1]+n(e)+m[2]+"\n"),e}function i(n){var r=d;if(s?n=s(n,t):o&&(n=n.replace(/\n/g,function(){return"$line="+ ++d+";"})),0===n.indexOf("=")){var a=$&&!/^=[=#]/.test(n);if(n=n.replace(/^=[=#]?|[\s;]*$/g,""),a){var i=n.replace(/\s*\([^\)]+\)/,"");f[i]||/^(include|print)$/.test(i)||(n="$escape("+n+")")}else n="$string("+n+")";n=m[1]+n+m[2]}return o&&(n="$line="+r+";"+n),g(e(n),function(e){if(e&&!h[e]){var n;n="print"===e?b:"include"===e?w:f[e]?"$utils."+e:p[e]?"$helpers."+e:"$data."+e,x+=e+"="+n+",",h[e]=!0}}),n+"\n"}var o=t.debug,c=t.openTag,l=t.closeTag,s=t.parser,u=t.compress,$=t.escape,d=1,h={$data:1,$filename:1,$utils:1,$helpers:1,$out:1,$line:1},v="".trim,m=v?["$out='';","$out+=",";","$out"]:["$out=[];","$out.push(",");","$out.join('')"],y=v?"$out+=text;return $out;":"$out.push(text);",b="function(){var text=''.concat.apply('',arguments);"+y+"}",w="function(filename,data){data=data||$data;var text=$utils.$include(filename,data,$filename);"+y+"}",x="'use strict';var $utils=this,$helpers=$utils.$helpers,"+(o?"$line=0,":""),j=m[0],T="return new String("+m[3]+");";g(r.split(c),function(e){var n=(e=e.split(l))[0],r=e[1];1===e.length?j+=a(n):(j+=i(n),r&&(j+=a(r)))});var k=x+j+T;o&&(k="try{"+k+"}catch(e){throw {filename:$filename,name:'Render Error',message:e.message,line:$line,source:"+n(r)+".split(/\\n/)[$line-1].replace(/^\\s+/,'')};}");try{var E=new Function("$data","$filename",k);return E.prototype=f,E}catch(e){throw e.temp="function anonymous($data,$filename) {"+k+"}",e}}var t=function(e,n){return"string"==typeof n?d(n,{filename:e}):o(e,n)};t.version="3.0.0",t.config=function(e,n){a[e]=n};var a=t.defaults={openTag:"<%",closeTag:"%>",escape:!0,cache:!0,compress:!1,parser:null},i=t.cache={};t.render=function(e,n){return d(e,n)};var o=t.renderFile=function(e,n){var r=t.get(e)||$({filename:e,name:"Render Error",message:"Template not found"});return n?r(n):r};t.get=function(e){var n;if(i[e])n=i[e];else if("object"==typeof document){var r=document.getElementById(e);if(r){var t=(r.value||r.innerHTML).replace(/^\s*|\s*$/g,"");n=d(t,{filename:e})}}return n};var c=function(e,n){return"string"!=typeof e&&("number"==(n=typeof e)?e+="":e="function"===n?c(e.call(e)):""),e},l={"<":"&#60;",">":"&#62;",'"':"&#34;","'":"&#39;","&":"&#38;"},s=function(e){return l[e]},u=Array.isArray||function(e){return"[object Array]"==={}.toString.call(e)},f=t.utils={$helpers:{},$include:o,$string:c,$escape:function(e){return c(e).replace(/&(?![\w#]+;)|[<>"']/g,s)},$each:function(e,n){var r,t;if(u(e))for(r=0,t=e.length;t>r;r++)n.call(e,e[r],r,e);else for(r in e)n.call(e,e[r],r)}};t.helper=function(e,n){p[e]=n};var p=t.helpers=f.$helpers;t.onerror=function(e){var n="Template Error\n\n";for(var r in e)n+="<"+r+">\n"+e[r]+"\n\n";"object"==typeof console&&console.error(n)};var $=function(e){return t.onerror(e),function(){return"{Template Error}"}},d=t.compile=function(e,n){function t(r){try{return new l(r,c)+""}catch(t){return n.debug?$(t)():(n.debug=!0,d(e,n)(r))}}n=n||{};for(var o in a)void 0===n[o]&&(n[o]=a[o]);var c=n.filename;try{var l=r(e,n)}catch(e){return e.filename=c||"anonymous",e.name="Syntax Error",$(e)}return t.prototype=l.prototype,t.toString=function(){return l.toString()},c&&n.cache&&(i[c]=t),t},g=f.$each,h=/\/\*[\w\W]*?\*\/|\/\/[^\n]*\n|\/\/[^\n]*$|"(?:[^"\\]|\\[\w\W])*"|'(?:[^'\\]|\\[\w\W])*'|\s*\.\s*[$\w\.]+/g,v=/[^\w$]+/g,m=new RegExp(["\\b"+"break,case,catch,continue,debugger,default,delete,do,else,false,finally,for,function,if,in,instanceof,new,null,return,switch,this,throw,true,try,typeof,var,void,while,with,abstract,boolean,byte,char,class,const,double,enum,export,extends,final,float,goto,implements,import,int,interface,long,native,package,private,protected,public,short,static,super,synchronized,throws,transient,volatile,arguments,let,yield,undefined".replace(/,/g,"\\b|\\b")+"\\b"].join("|"),"g"),y=/^\d[^,]*|,\d[^,]*/g,b=/^,+|,+$/g,w=/^$|,+/;a.openTag="{{",a.closeTag="}}";var x=function(e,n){var r=n.split(":"),t=r.shift(),a=r.join(":")||"";return a&&(a=", "+a),"$helpers."+t+"("+e+a+")"};a.parser=function(e){var n=(e=e.replace(/^\s/,"")).split(" "),r=n.shift(),a=n.join(" ");switch(r){case"if":e="if("+a+"){";break;case"else":e="}else"+(n="if"===n.shift()?" if("+n.join(" ")+")":"")+"{";break;case"/if":e="}";break;case"each":var i=n[0]||"$data",o=n[1]||"as",c=(n[2]||"$value")+","+(n[3]||"$index");"as"!==o&&(i="[]"),e="$each("+i+",function("+c+"){";break;case"/each":e="});";break;case"echo":e="print("+a+");";break;case"print":case"include":e=r+"("+n.join(",")+");";break;default:if(/^\s*\|\s*[\w\$]/.test(a)){var l=!0;0===e.indexOf("#")&&(e=e.substr(1),l=!1);for(var s=0,u=e.split("|"),f=u.length,p=u[s++];f>s;s++)p=x(p,u[s]);e=(l?"=":"=#")+p}else e=t.helpers[r]?"=#"+r+"("+n.join(",")+");":"="+e}return e},"function"==typeof define?define(function(){return t}):"undefined"!=typeof exports?module.exports=t:this.template=t}();
